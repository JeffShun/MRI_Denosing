...
def plot_box(datas, labels):
    ...
    colors = ['rgb(0,120,40)', 'rgb(50,100,200)','rgb(200,100,90)','rgb(100,220,90)','rgb(200,30,90)','rgb(100,30,50)','rgb(100,200,0)']
...
if __name__ == "__main__":
    ...
    for model in compare_models:
        csv_path = "../example/data/output/Para2/%s-512/metric_data/metrics.csv"%(model)
