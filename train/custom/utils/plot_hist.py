...
def plot_box(datas, labels):
    ...
    colors = ['rgb(0,120,40)', 'rgb(50,100,200)','rgb(200,100,90)','rgb(100,220,90)','rgb(200,30,90)']
...
if __name__ == "__main__":
    compare_models = ["U-Net", "MoDL","VN","PM-DUNET","CAMERA-Net"]
    datas_psnr = []
    datas_ssim = []
    datas_nmse = []
    for model in compare_models:
        csv_path = "../example/data/output/Paper-compare/%s/metrics.csv"%(model)
