...
for i in test_epochs:
    ...
    os.chdir("../train")
    os.system("python custom/utils/cal_matrics.py --pred_path ../example/data/%s_output --output_path ../example/data/%s_output/logs/%d.csv --print_path %s"%(version,version,i,log_path))
